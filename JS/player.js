...
class Player {
	...
	display(){
		...
		this.i=int((1/gb)*this.sprite.y -1)
		this.j=int((1/gb)*this.sprite.x -1)
		this.sprite.shapeColor= rgb(map(this.health,0,25,255,0,true),map(this.health,0,50,0,255,true),0)
		 this.move()
		//console.log(this.i,this.j)
	...
	move(){
		...
		if(pth){
		   ...
		   var t=this.target;var s =this.sprite;var speed=gb/5
	...
	drawPath(){
		...
		pop()
		   ...
		   push()
		   var v1=createVector((a.x+1)*gb,(a.y+1)*gb)
		   var v2=createVector((b.x+1)*gb,(b.y+1)*gb)
		   //console.log(v1,v2)
			drawArrow(v1,v2)
